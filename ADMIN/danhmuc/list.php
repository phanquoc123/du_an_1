...
<aside>
   <table>
    ...
    <tr>
      ...
      <td><a href=""><input id="nut_sua" type="button" value="Sửa"></a>  <a onclick="return confirm('Có chắc muốn xóa không')" href="index.php?act=delete_danhmuc&id=<?=$list_dm['id_category']?>"><input id="nut_xoa" type="button" value="Xóa"></a></td>
    </tr>
